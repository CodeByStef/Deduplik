...
### Changed
  - Column order: AllFiles count before Uniques and Duplicates in FolderTree.
### Fixed
  - File rooted FocusGraph did not connect to clicked file when ShowFiles enabled.
  - Recusive KeepAndRemove could skip subfolders in a specific situation.
